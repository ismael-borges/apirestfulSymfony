 ...
 */
final class Version20220206035414 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medico CHANGE nome nome VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
